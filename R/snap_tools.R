#' Snap road endings
#'
#' Snap road endings together, without prior knowledge of road connections, to post-process and correct
#' inaccuracies generated by \link{measure_roads} and ensure getting topologically valid network.
#'
...
#' Snap road endings 
#'
#' Snap road endings together, using prior knowledge of road connections, to post-process and correct
#' inaccuracies generated by \link{measure_roads} and ensure getting topologically valid network.
#'
#' @param roads  multiples lines (\code{sf} format). Corrected but unconnected roads.
