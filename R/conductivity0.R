...
#' @export
rasterize_conductivity <- function(las, dtm = NULL, param = old_alsroads_default_parameters, ...)
{
  UseMethod("rasterize_conductivity", las)
}

#' @export
rasterize_conductivity.LAS <- function(las, dtm = NULL, param = old_alsroads_default_parameters, ...)
{
...
#' @export
rasterize_conductivity.LAScluster = function(las, dtm = NULL, param = old_alsroads_default_parameters, ...)
{
  x <- lidR::readLAS(las)
...
#' @export
rasterize_conductivity.LAScatalog = function(las, dtm = NULL, param = old_alsroads_default_parameters, ...)
{
